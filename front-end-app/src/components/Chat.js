...
const Chat = ({
    ...
    useEffect(() => {
        const onMessageReceived = (value) => {
            ...
            if (encryptionKey) {
                receivedMessage = decryption(receivedMessage, encryptionKey)
            }
            message.msg = parseJsonSafely(receivedMessage).data
    ...
    const handleSendMessage = () => {
        ...
        if (encryptionKey) {
            sendMsg = encryption(JSON.stringify(sendMsg), encryptionKey)
        }
        message.msg = sendMsg
