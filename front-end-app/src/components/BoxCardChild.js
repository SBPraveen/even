...
const BoxCardChild = ({ data, onClose }) => {
    return (
        
            <Box sx={{ boxShadow: 1, borderRadius: "3px", bgcolor: "primary.tabs", display: "flex", position: "relative", alignItems: "center", cursor: "pointer", marginRight: "1.5rem", width:"30%", minWidth:"70px", paddingLeft:"0.3rem"}} >
                <Tooltip title={data.cookieName} placement="bottom">
                <Box sx={{whiteSpace: "nowrap", textOverflow: "ellipsis", overflow: "hidden", display: "block", color: "text.disabled" }}>
