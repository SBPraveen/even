      ...
      <Tabs tabsData={tabsData} onCreateNewTab={onCreateNewTab} onTabClose={onTabClose} />
      {
        isServerStarted ?
          <Box sx={{ flex: 1, width: "100%", display: "flex", alignItems: "center", justifyContent: "center", }}>
            <WebSocketServerStarted port={port} url={url} setIsServerStarted={setIsServerStarted} encryptionKey={encryptionKey} />
          </Box>
          :
          <Box sx={{ flex: 1, width: "100%", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <WebSocketInitPage setIsServerStarted={setIsServerStarted} setPort={setPort} setUrl={setUrl} setEncryptionKey={setEncryptionKey}/>
          </Box>
      }
